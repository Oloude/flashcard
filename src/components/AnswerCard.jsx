...
function AnswerCard({answer}) {
  return (
    <div className="w-full h-full bg bg-blue400 relative flex flex-col gap-6 justify-center items-center">
        ...
        <h2 className="text-preset2 text-neutral900 text-center">{answer}</h2>
