...
function QuestionCard() {
  return (
    <div className="w-full h-full bg bg-pink400 relative flex flex-col gap-10 justify-center items-center">
        ...
        <h1 className="text-preset1M md:text-preset1T lg:text-preset1 text-neutral900 text-center"></h1>
